...
impl Theme {
    pub fn dark() -> Self {
        Self {
            is_dark: true,
            bg: rgba_const(0x111216ff),
            sidebar_bg: rgba_const(0x15161dff),
            card_bg: rgba_const(0x181920ff),
            card_hover: rgba_const(0x1e2028ff),
            card_border: rgba_const(0x23252eff),
            card_border_hover: rgba_const(0x353846ff),
            row_hover: rgba_const(0x1e2028ff),
            row_selected: rgba_const(0x2563eb26),
            table_header: rgba_const(0x15161dff),
            input_bg: rgba_const(0x14151cff),
            input_border: rgba_const(0x2a2d38ff),
            text_primary: rgba_const(0xf3f4f6ff),
            text_secondary: rgba_const(0x9ca3afff),
            text_muted: rgba_const(0x6b7280ff),
            accent: rgba_const(0x2563ebff),
            accent_hover: rgba_const(0x3b82f6ff),
            accent_subtle: rgba_const(0x2563eb26),
            ...
            track_off: rgba_const(0x2a2d38ff),
            thumb: rgba_const(0xf3f4f6ff),
            modal_backdrop: rgba_const(0x000000cc),
            pill_bg: rgba_const(0x181920f2),
